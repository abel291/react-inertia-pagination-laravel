            ...
            <ul className="flex flex-row items-center gap-1">
                ...
                <li>
                    {paginateItems.prev_page_url
                        ? (
                            <Link className="pagination-page mr-3" href={paginateItems.prev_page_url}>
                        ...
                        : (
                            <span className="pagination-page mr-3">
                ...
                <li>
                    {paginateItems.next_page_url
                        ? (
                            <Link className="pagination-page ml-3" href={paginateItems.next_page_url}>
                                Siguiente
                        ...
                        : (
                            <span className="pagination-page ml-3">
                                Siguiente
